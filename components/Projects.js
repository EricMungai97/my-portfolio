          ...
          {projects.map((project,i) => (
            <div key={i} className="w-screen flex-shrink-0 snap-center flex flex-col space-y-5 items-center justify-center p-20 md:p-44 h-screen">
              ...
              <div className="space-y-10 px-0 md:px-10 max-w-6xl">
                ...
                <Link href={project.github} className="text-gray-500 hover:text-[#F7AB0A] dark:hover:text-white flex justify-center">
                    ...
                    <p className="px-6 py-2 border border-[#242424] rounded-full uppercase text-xs tracking-widest text-gray-500 transition-all hover:border-[#F7AB0A]/40 hover:text-[#F7AB0A]/40 text-center">Live Site</p>
                    </Link>
                    </div>
              </div>
            </div>
